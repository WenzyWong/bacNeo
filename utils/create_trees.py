...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Creating a phylogenetic tree and OTU table from Kraken2 reports by pruning NCBI trees."
    )
    parser.add_argument(
        "--input_dir",
        "-i",
        required=True,
        help="Directory containing Kraken2 report files. Named with a suffix .standard if it was generated by bacNeo --bacc.",
    )
    parser.add_argument(
        "--out_prefix",
        "-o",
    ...
    parser.add_argument(
        ...
        "-t",
        default=30,
        help="Top ranked number (default: 30) based on species abundance across all samples.",
    )
